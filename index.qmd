...
![01](images/IMG_6744.jpg){description="`r descrip_exif('images/IMG_6744.jpg')`" desc-position="left" group="figueroa"}
...
::: {style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr));grid-gap: 1em;"}
![01](images/IMG_6764.jpg){description="'r descrip_exif('images/IMG_6764.jpg')`" desc-position="left" group="jalama"}
